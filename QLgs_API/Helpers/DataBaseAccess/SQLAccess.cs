...
namespace QLgs.EdoCta.API.Helpers.DataBaseAccess
{
    public class SQLAccess
    {
        ...
        public Task<int> ExecuteNonQuery(string procedureName, List<DbParameter> parameters, CommandType commandType = CommandType.StoredProcedure)
        {
            //int returnValue = -1;
        ...
        public Task<DbDataReader> GetDataReader(string procedureName, List<SqlParameter> parameters, CommandType commandType = CommandType.StoredProcedure)
        {
            //DbDataReader ds;
        ...
        public List<SqlParameter> IniListParameter()
        {
