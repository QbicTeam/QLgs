...
namespace QLgs.EdoCta.API.Controllers
{
    ...
    public class AuthController: ControllerBase
    {
        ...
        {
            var userFromRepo = await _repo.LoginLgs(userForLoginDTO.UserName.ToLower(), userForLoginDTO.Password);
            ...
            //userFromRepo.UserName = userFromRepo.UserName.Split(" y ")[0]; // Usarlo si mandan la Formacion Contractual.
        ...
        /*
                ...
                public async Task<ActionResult> GetUserSettings(int id) {
                    ...
                    {
                        result.PhotoUrl = "http://majahide-001-site1.itempurl.com/releasecandidates/PhotosManagerAPI/prometheusmedia/QLgs.EdoCtaPROFILES/UserProfiles/nopic.jpg";
                    }
